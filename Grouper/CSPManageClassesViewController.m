...
@interface CSPManageClassesViewController ()

@end

@implementation CSPManageClassesViewController
...
- (id)init
{
    self = [super initWithNibName:@"CSPManageClassesViewController" bundle:nil];
    if (self) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell = (CSPClassListTableViewCell *) [self.tableView dequeueReusableCellWithIdentifier:uniqueIdentifier];
    if (!cell) {
        NSArray *topLevelObjects = [[NSBundle mainBundle] loadNibNamed:@"CSPClassListTableViewCell" owner:nil options:nil];
        for (id currentObject in topLevelObjects) {
            cell = (CSPClassListTableViewCell *)currentObject;
            break;
        }
    }
